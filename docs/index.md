...
<hr style="border: 2px solid #98BF18;">
...
<div  style="background-color: white; border: 1px solid black; padding: 10px; text-align: justify;">
  <h2 id="4-présentation" >4 Présentation</h2>
</div>

### <span style="color: white; background-color: #98BF18; padding: 2px 5px;">4.1 Lancement du plugin</span>

<div style="display: flex; justify-content: center; align-items: center; gap: 20px;">
		<img  src="Image1.png"  style="vertical-align: middle;" />  
		<img  src="Image2.png"  style="vertical-align: middle;" />
</div>
...
### <span style="color: white; background-color: #98BF18; padding: 2px 5px;">4.2 Fonctionnalités</span>
...
Si une vue du même nom existe déjà l’outil fais une mise à jour de celle-ci
